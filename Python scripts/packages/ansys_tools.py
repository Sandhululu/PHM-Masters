...
"""
ANSYS TOOLS
Created on Fri Aug 27 16:42:58 2021
...
def read_nodes(fe_opts):
    ...
    data_array = np.array(util.read_data_by_spec(file_path,val_spec,max_len))
...
def read_elems(fe_opts):
    ...
    data_list = util.read_data_after_header(file_path, header)
